        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p 
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              With us, your community benefits from a <span className="text-primary font-semibold">robust safety framework</span> that keeps residents protected, facilities compliant, and operations running seamlessly.
            </motion.p>
          </motion.div>
        </div>
      </section>
