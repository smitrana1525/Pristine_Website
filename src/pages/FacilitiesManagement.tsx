        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p 
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              With us, your community benefits from <span className="text-primary font-semibold">proactive maintenance, responsive service</span>, and a premium operational standard that ensures peace of mind for every homeowner.
            </motion.p>
          </motion.div>
        </div>
      </section>
