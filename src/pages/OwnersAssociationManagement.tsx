        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p 
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              With us, your community enjoys a <span className="text-primary font-semibold">smooth, compliant, and professionally governed</span> environment that supports stability, confidence, and harmonious living.
            </motion.p>
          </motion.div>
        </div>
      </section>
